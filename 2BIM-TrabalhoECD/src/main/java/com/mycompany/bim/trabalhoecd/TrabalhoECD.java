package com.mycompany.bim.trabalhoecd;

import com.mycompany.bim.trabalhoecd.models.Conta;
...
public class TrabalhoECD {
    ...
    public static void Menu() {
        ...
        System.out.println("2) Ordenar Contas Bancarias");
    ...
    public static void ordenarContas(Scanner scanner) {
        ...
        System.out.println("Ordenar Contas Bancarias:");
    ...
    public static void realizarDeposito(Scanner scn) {
        ...
        Conta conta = new Conta(numContas, numContas, "");
    ...
    public static void realizarSaque(Scanner scn) {
        if (numContas == 0) {
            System.out.println("Não há contas cadastradas");
            return;
        }
        ...
        if (contas.sacar(valorSaque)){
            ...
            System.out.println("Novo saldo da conta: " + contas.getSaldo());
        } else {
    ...
    public static void saldoNegativo() {
        ...
        if (saldoNegativo) {
            System.out.println("Alguma conta possui saldo negativo!");
        } else {
